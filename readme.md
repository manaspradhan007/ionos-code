...
This repository manages the infrastructure using Terraform and Terragrunt. It follows a modular and declarative approach to define, provision, and manage cloud resources across different environments.

we are using Terraform for cloud infrastructure resource creation and Terragrunt for passing the inputs which enables us to keep our infrastructure code DRY (Don't Repeat Yourself) by managing common configurations and orchestrating deployments across multiple environments and components.


## Project Overview

This repository contains all the Infrastructure as Code (IaC) definitions. We utilize:

* **Terraform:** For defining infrastructure components (e.g., S3, Kubernetes, ingress, argocd, grafana).
* **Terragrunt:** For keeping Terraform configurations DRY (Don't Repeat Yourself), managing remote state, and orchestrating deployments across multiple environments (e.g., `dev`, `prod`) and components.

This approach ensures consistency, version control, and automation for our infrastructure deployments on IONOS Cloud.

## Directory Structure

The repository is organized as follows:
├── infrastructure/
│   ├── terraform/      # Contains reusable Terraform modules and core configurations
│   │   ├── modules/    # Reusable, self-contained Terraform modules (e.g., vpc, ec2-instance, rds)
│   │   └── resources/    # Global Terraform configurations or settings if applicable
│   │
│   └── terragrunt/     # Orchestrates Terraform configurations for different environments
│       ├── _env_template/ # Template for new environments
│       ├── dev/        # Development environment configurations
│       ├── prod/       # Production environment configurations


## To execute the cloud infrastructure: 
